        ...
        if (data[0]) {
          ...
          db.tx(t => {
            return t.batch([
              ...
              t.none(`UPDATE Media SET rating=(SELECT ROUND(AVG(rating)::numeric, 1) FROM Review_Writes_About WHERE mediaID=$1 GROUP BY mediaID) WHERE mediaID=$1`, [req.body.mediaID])
            ])
          }).then(data => {
